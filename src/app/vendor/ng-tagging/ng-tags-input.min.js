...
(function () {
    ...
    tagsInput.directive('tagsInput', ["$timeout", "$document", "$window", "tagsInputConfig", "tiUtil", function ($timeout, $document, $window, tagsInputConfig, tiUtil) {
        function TagList(options, events, onTagAdding, onTagRemoving, onInvalidTag) {
            var self = {}, getTagText, setTagText, tagIsValid, tagIsDuplicate;
            ...
            tagIsDuplicate = function (tag) {
                var res = !tiUtil.findInObjectArray(self.items, tag, options.keyProperty || options.displayProperty);
                if (!res) {
                    onInvalidTag({ $tag: tag });
                }
                return res;
            };
        ...
        return {
            ...
            replace: false,
            transclude: true,
            templateUrl: 'app/vendor/ng-tagging/templates/tags-input.html',
            controller: ["$scope", "$attrs", "$element", function ($scope, $attrs, $element) {
                $scope.events = tiUtil.simplePubSub();

                tagsInputConfig.load('tagsInput', $scope, $attrs, {
                    template: [String, 'vendor/ng-tagging/templates/tag-item.html'],
                ...
                $scope.tagList = new TagList($scope.options, $scope.events,
                    ...
                    tiUtil.handleUndefinedResult($scope.onInvalidTag, true)
                );
            ...
            link: function (scope, element, attrs, ngModelCtrl) {
                ...
                setDuplicateElementValidity = function () {
                    var tempTag = scope.newTag;
                    tempTag.name = tempTag.text;

                    ngModelCtrl.$setValidity('duplicateTag', tiUtil.findInObjectArray(scope.tags, tempTag, 'name') ? false : true);
                }
                        ...
                        blur: function () {
                            $timeout(function () {
                                ...
                                if (lostFocusToBrowserWindow || !lostFocusToChildElement) {
                                    ...
                                    events.trigger('input-duplicate');
                                }
                            });
                        },
                ...
                events
                    ...
                    .on('duplicate-tag', function (data) {
                        scope.onInvalidTag();
                    })
    ...
    tagsInput.directive('autoComplete', ["$document", "$timeout", "$sce", "$q", "tagsInputConfig", "tiUtil", function ($document, $timeout, $sce, $q, tagsInputConfig, tiUtil) {
        ...
        return {
            ...
            require: '^tagsInput',
            scope: { source: '&' },
            templateUrl: 'app/vendor/ng-tagging/templates/auto-complete.html',
            controller: ["$scope", "$element", "$attrs", function ($scope, $element, $attrs) {
                $scope.events = tiUtil.simplePubSub();

                tagsInputConfig.load('autoComplete', $scope, $attrs, {
                    template: [String, 'vendor/ng-tagging/templates/auto-complete-match.html'],
