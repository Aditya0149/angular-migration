(function (factory) {
    ...
    SimpleBar.prototype.startScroll = function (e) {
        ...
        this.flashScrollbar();
        if ($("#customStickyHeader").length > 0) {
            var header = document.getElementById("customStickyHeader");
            var sticky = header.offsetTop;
            if (e.currentTarget.scrollTop > sticky) {
...
if (OSName == "MacOS" && isChrome == true) {
    $("#myElement").attr("style", "overflow:" + "auto");
} else {
    $('#myElement').simplebar();
}