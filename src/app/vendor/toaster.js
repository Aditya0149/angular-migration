...
(function (window, document) {
    ...
    angular.module('toaster', []).constant(
        ...
        $templateCache.put('angularjs-toaster/toast.html',
            ...
            '<div ng-switch-when="directive"><div directive-template directive-name="{{toaster.html}}" directive-data="{{toaster.directiveData}}" toast-instance="toaster"></div></div>' +
                    ...
                    return {
                        ...
                        link: function (scope, elm, attrs) {
                            ...
                            function addToast(toast, toastId) {
                                ...
                                if(toast.directiveData && toast.directiveData.notification_type){
                                    toast.type += " toast-" + toast.directiveData.notification_type;
                                }
                                if (!toast.type) {
