...
// Called from a translation file.
    ...
    function Calendar(element, instanceOptions) {
        ...
        function initialRender() {
            ...
            // commented below line to hide header row
    ...
    $.extend(DayGrid.prototype, {
        ...
        dayRowHtml: function(row, isRigid) {
            ...
            return '' +
                ...
                '</table>' +
                '</div>' +
                '<div class="fc-content-skeleton" mb-scrollbar="scrollbar("vertical", true)">' +
                '<table>' +
                (this.numbersVisible ?
                    '<thead>' +
    ...
    $.extend(TimeGrid.prototype, {
        ...
        slatRowHtml: function() {
            ...
            while (slotTime < this.maxTime) {
                ...
                axisHtml =
                    '<td id="'+htmlEscape(calendar.formatDate(slotDate, 'h(:mm)a'))+'"class="fc-axis fc-time ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '>' +
    ...
    $.extend(AgendaView.prototype, {
        ...
        renderHtml: function() {
            return '' +
                ...
                '<td class="' + this.widgetContentClass + '">' +
                (this.dayGrid ?
                    '<div id="allDayHeader" class="fc-day-grid"/>' +
