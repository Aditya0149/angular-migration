(function () {
    ...
    angular
        ...
        .factory('donutHelper', donutHelper);

    function donutHelper() {
        return {
    ...
    donut.$inject = ['donutHelper', '$rootScope'];
    function donut(donutHelper, $rootScope) {
        ...
        function linkFn(scope, el, attr, clxC3) {
            var values = donutHelper.getValuesForDonut(scope.data, scope.donutFor, scope.donutVal),
                names = donutHelper.getNames(scope.data, scope.donutFor, scope.displayVal),
