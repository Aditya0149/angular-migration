(function (angular) {
    ...
    angular.module('intake.report').controller('IntakeCampaignFilterCtrl', ['$modalInstance',
        ...
        function ($modalInstance, params, matterFactory, notificationService, contactFactory, $scope, globalConstants, intakeNotesDataService) {
            ...
            $scope.$watch(function () {
                if (vm.selectionModel.multiFilters.status.length > 0 || vm.selectionModel.multiFilters.types.length > 0 ||
                    utils.isNotEmptyVal(vm.viewModel.userFilter.referebyFilter) || utils.isNotEmptyVal(vm.viewModel.userFilter.referetoFilter) || utils.isNotEmptyVal(vm.viewModel.userFilter.leadNameFilter) || vm.tags.length > 0 || (utils.isNotEmptyVal(vm.viewModel.filter.s) && utils.isNotEmptyVal(vm.viewModel.filter.e))) {
