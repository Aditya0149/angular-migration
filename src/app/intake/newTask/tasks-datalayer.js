(function (angular) {
    ...
    angular
        .module('intake.tasks')
        .factory('LauncherTasksDatalayer', LauncherTasksDatalayer);
    LauncherTasksDatalayer.$inject = ['$http', 'globalConstants', '$q'];

    function LauncherTasksDatalayer($http, globalConstants, $q) {
