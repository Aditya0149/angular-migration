(function (angular) {
    ...
    angular.module('intake.workflow')
        .controller('addintakeTaskController', addintakeTaskController);

    addintakeTaskController.$inject = ['$modal', 'intakeaddTaskDatalayer', 'intakeworkflowHelper', 'notification-service', 'intakeworkFlowTemplateDataService'];
    function addintakeTaskController($modal, intakeaddTaskDatalayer, intakeworkflowHelper, notificationService, intakeworkFlowTemplateDataService) {

        var vm = this,
            subcategory = {};
        var taskData = intakeworkFlowTemplateDataService.getSelectedTaskData();
        vm.save = save;
        vm.cancel = cancel;
        ...
        //     vm.dateFieldValue =0;
        //     vm.taskInfo.beforeAfter = "Before";
        ...
        (function () {
            ...
            if (vm.mode == 'Edit') {
                //var editData = JSON.parse(taskData.workflow_date);
        ...
        function formatDates(editData) {
            ...
            vm.taskInfo.SOL = angular.isDefined(editData.intake_event[0]) ? utils.isNotEmptyVal(editData.intake_event[0].code) ? "1" : 0 : 0;
        ...
        function formatData(taskData) {
            ...
            vm.dateFieldValue = copyTask.beforeAfter == "Before" ? 0 : 1;
            ...
            if (utils.isNotEmptyVal(copyTask.assigned_users_role)) {
                copyTask.roleid = copyTask.assigned_users_role;
            }
        ...
        function addTask(task, subcategory) {
            ...
            intakeaddTaskDatalayer.addTask(postTaskData)
                .then(function (response) {
        ...
        function editTask(task, subcategory) {
            ...
            var postTaskData = getPostTaskData(task);
            intakeaddTaskDatalayer.editTask(postTaskData)
                .then(function (response) {
...
(function (angular) {
    ...
    angular.module('intake.workflow')
        .factory('intakeaddTaskDatalayer', intakeaddTaskDatalayer);

    intakeaddTaskDatalayer.$inject = ['$http', 'globalConstants'];
    function intakeaddTaskDatalayer($http, globalConstants) {

        var urls = {
            editTask: globalConstants.intakeServiceBaseV2 + 'workflow_template/task/',
            addTask: globalConstants.intakeServiceBaseV2 + 'workflow_template/task',
