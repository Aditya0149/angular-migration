(function() {
    ...
    angular
        ...
        .controller('NotificationSelectionCtrl', NotificationSelectionCtrl);

    NotificationSelectionCtrl.$inject = ['practiceAndBillingDataLayer', '$modal', 'masterData', 'routeManager', 'notification-service', 'applicationsDataLayer', '$rootScope', '$scope', 'launcherDatalayer', '$state'];

    function NotificationSelectionCtrl(practiceAndBillingDataLayer, $modal, masterData, routeManager, notificationService, applicationsDataLayer, $rootScope, $scope, launcherDatalayer, $state) {
        var vm = this
